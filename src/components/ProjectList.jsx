        ...
        <div className='bg-stone-50 min-h-screen pb-10'>
            <div className='container xl:max-w-[1164px] px-6 mx-auto'>
                <ul className='flex items-center justify-center mb-12 gap-10 pt-5'>
                    <li><a href="" onClick={(e) => { e.preventDefault(); setOpentab(1) }} className={`${opentab === 1 ? "text-teal-700 after:left-0 after:w-full after:h-[2px] after:bg-teal-700 after:bottom-[-3px] after:absolute after:right-0 after:rounded-sm" : ""} after:duration-300 relative after:ease-linear after:transition-all transition-all duration-300 ease-linear text-[30px] font-bold text-stone-800 `}>January</a></li>
                    <li><a href="" onClick={(e) => { e.preventDefault(); setOpentab(2) }} className={`${opentab === 2 ? "text-teal-700 after:left-0 after:w-full after:h-[2px] after:bg-teal-700 after:bottom-[-3px] after:absolute after:right-0 after:rounded-sm" : ""} after:duration-300 relative after:ease-linear after:transition-all transition-all duration-300 ease-linear text-[30px] font-bold text-stone-800 `}>February</a></li>
                    <li><a href="" onClick={(e) => { e.preventDefault(); setOpentab(3) }} className={`${opentab === 3 ? "text-teal-700 after:left-0 after:w-full after:h-[2px] after:bg-teal-700 after:bottom-[-3px] after:absolute after:right-0 after:rounded-sm" : ""} after:duration-300 relative after:ease-linear after:transition-all transition-all duration-300 ease-linear text-[30px] font-bold text-stone-800 `}>March</a></li>
                    <li><a href="" onClick={(e) => { e.preventDefault(); setOpentab(4) }} className={`${opentab === 4 ? "text-teal-700 after:left-0 after:w-full after:h-[2px] after:bg-teal-700 after:bottom-[-3px] after:absolute after:right-0 after:rounded-sm" : ""} after:duration-300 relative after:ease-linear after:transition-all transition-all duration-300 ease-linear text-[30px] font-bold text-stone-800 `}>April</a></li>
                </ul>
                    ...
                    <div className={opentab === 3 ? "block" : "hidden"}>
                        ...
                        <div className='flex justify-between items-center mt-10'>
                            ...
                            <div className='w-[55%]'>
                                ...
                                <h3 className=' text-[28px] font-bold text-black mb-2 mt-4'>Live Link:</h3>
                                <a href="https://fhttps://pixelperfect-seven.vercel.app/" target='_blank' className='text-[22px] font-semibold hover:text-teal-700 transition-all duration-300 ease-linear'>https://pixelperfect-seven.vercel.app/</a>
                            </div>
                        </div>
                        <div className='flex justify-between items-center mt-10'>
                            <div className='w-[40%]'>
